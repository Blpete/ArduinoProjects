...
void setup()
{
   ...
   playNote('f', 500);
    ...
    myservo.attach(10);  // attaches the servo on pin 10 (servo1) to the servo object 
}
...
//          }
        ...
        else if (results.value == 312417881)
        {
          Serial.println("STOP");
          goBackward(100);
          forwardMode= false;
        }
        else if  (results.value == 402094229)
        {
          Serial.println("REW");
        ...
        else if (results.value == 3933546233)
        {
       ...
       else if (results.value ==  3695300350)
       {
